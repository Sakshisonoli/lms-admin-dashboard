...
import {
  Dashboard as DashboardIcon, Message as MessageIcon,
  Notifications as NotificationsIcon, ExitToApp as LogoutIcon,
  Description as DocumentIcon, QuestionAnswer as QueryIcon,
  School as TrainerIcon, Person as PersonIcon,
          ...
          <ListItem key={item.text} disablePadding sx={{ mb: 0.5 }}>
            ...
            >
              ...
              >
                <Badge
                  badgeContent={
                    item.path === '/student/messages' ? (counts.messages || null) :
                    null
                  }
